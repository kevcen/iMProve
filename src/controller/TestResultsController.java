...
public class TestResultsController {
    ...
    //ui objects
    @FXML
    private Text txtScore, txtComment;
    @FXML
    private VBox vbxFeedbacks;
    ...
    public void updateDB() {
        try (
            ...
            int hiscore = -1;
            if (oldScoreRs.next())
                hiscore = oldScoreRs.getInt("Highscore"); //if a score exists for this date, take it for current the hiscore
