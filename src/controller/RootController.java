...
public class RootController {
    ...
    @FXML
    private AnchorPane apnRoot, apnActivity;
    @FXML
    private StackPane spnLearn, spnTest, spnListen, spnReview;
    @FXML
    private MaterialDesignIconView icnLearn, icnTest, icnListen, icnReview;
    @FXML
    private JFXButton btnLearn, btnTest, btnListen, btnReview;
    @FXML
    private Text txtTime, txtWelcome;
    @FXML
    private VBox vbxActivities;
    ...
    public static String getColourCode(int option) {
        ...
        switch (theme) {
            case "Default Chamber":
                switch (option) {
                    case 0:
                        colourCode = "#001421"; //unselected background
                        break;
                    case 1:
                        colourCode = "#c18303"; //selected background/ unselected text
                        break;
                    case 2:
                        colourCode = "#ffffff"; //selected text
                        break;
                    case 3:
                        colourCode = "#daa34b"; //selected icon
                        break;
                    case 4:
                        colourCode = "#262b1a"; //unselected icon
                        break;
                }
                break;
            case "Future Sea":
    ...
    private void setCSS(String theme) {
        ...
        switch (theme) {
            case "Future Sea":
                fileName += "future_sea.css";
                break;
            case "Default Chamber":
                fileName += "default_chamber.css";
                break;
            case "Rose Petal":
                fileName += "rose_petal.css";
                break;
            case "The Panda Special":
                fileName += "panda_special.css";
        }
