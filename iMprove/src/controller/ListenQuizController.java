...
public class ListenQuizController {
    ...
    //UI objects
    @FXML
    private JFXButton btnRelMaj, btnRelMin, btnSub, btnDom, btnAgain;
    @FXML
    private MaterialDesignIconView icnPlayPause;
    @FXML
    private JFXSlider sldSeek;
    @FXML
    private AnchorPane apnFirstPlay, apnQuiz;
    ...
    public void answerQuestion(ActionEvent e) {
        if (!answered) { //if hasn't been answered yet - this will make clicks to other buttons not change their colour
            ...
            switch (currentTest.getModulation()) {
                case "Relative Major":
                    btnRelMaj.setStyle("-fx-background-color: #0cb794; -fx-text-fill: white;" + (pandaTheme ? "-fx-background-image: null;" : ""));
                    break;
                case "Relative Minor":
                    btnRelMin.setStyle("-fx-background-color: #0cb794; -fx-text-fill: white;" + (pandaTheme ? "-fx-background-image: null;" : ""));
                    break;
                case "Dominant":
                    btnDom.setStyle("-fx-background-color: #0cb794; -fx-text-fill: white;" + (pandaTheme ? "-fx-background-image: null;" : ""));
                    break;
                case "Subdominant":
                    btnSub.setStyle("-fx-background-color: #0cb794; -fx-text-fill: white;" + (pandaTheme ? "-fx-background-image: null;" : ""));
                    break;
            }
